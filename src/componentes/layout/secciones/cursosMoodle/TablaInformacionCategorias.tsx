...
export default function TablaInformacion({infUsers,seleccionUsuarios, actualizacionEstado, usuarioCookie,restaurarUsuario}:any) {
  ...
  // console.log(datosCategorias)
    ...
    <thead>
      ...
      <th className={estilos.filaHead}></th>
        <th className={estilos.filaHead}>Id_Categoría</th>
        <th className={estilos.filaHead}>Nombre</th>
        <th className={estilos.filaHead}>Id_Number</th>
        <th className={estilos.filaHead}>Cursos</th>
          ...
          infUsers.map((e: any, index: number) => (
            ...
            <tr className={estilos.filastr} key={index}>   
                  ...
                  <td className={estilos.filas}>
                    ...
                    <td className={estilos.filas}>{e.idnumber}</td>
                    <td className={estilos.filas}>{e.coursecount}</td>
