...
import TablaInformacion from "./TablaInformacionCategorias";
...
export default function InformacionUserMoodle({
  ...
  const buscarCategoria = (input: any) => {
    if (input === "") {
  ...
  const eliminarEnvioDatos = async () => {
    ...
    try {
      ...
      setEstadoVentanaEliminacion(false);
      loadingToastId = toast.info(
        "Eliminando categoría/categorías, esto puede llevar un momento...",
        {
          style: {
            border: "none",
          },
      ...
      selectedUserIds.forEach(async(e) => {
        await axios.get(
          `${moodle.host}/webservice/rest/server.php?wstoken=${moodle.token}&wsfunction=core_course_delete_categories&moodlewsrestformat=json&categories[0][id]=${e}&categories[0][recursive]=1`
        );
      ...
      toast.success("La categoría/categorías fueron eliminados exitosamente", {
        style: {
          backgroundColor: "rgb(90,203,154)",
          border: "none",
        },
      ...
      toast.dismiss(loadingToastId);
      toast.error("Ha ocurrido un error al eliminar los datos de la categoría/categorías.", {
        style: {
          backgroundColor: "rgb(203,90,90)",
          border: "none",
        },
        ...
        <div className={estilos.fondo}>
          <div className={estilos.contenedorMensaje} id="contenedor">
            ...
            <div className={estilos.contenedorInformacion}>
              ...
              <p>
    La eliminación de los registros seleccionados es irreversible. Los cursos que estén asociados a esta categoría también serán eliminados. ¿Desea continuar con esta acción?
</p>
      ...
      <div className={estilos.contendorCrudUsuarios}>
          ...
          <div className={estilos.contenedorOpciones}>
            ...
            <div className={estilos.contenedorBotones}>
              ...
              <button className={estilos.btnAgregar}>
                {" "}
                <Link target="_BLANK" href={"/moodle/crearcategoria"}>
                  Agregar
                </Link>
              </button>
                <button
        ...
        <div className={estilos.contenedorTablaCategoria}>
          <TablaInformacion
            infUsers={infUsers}
