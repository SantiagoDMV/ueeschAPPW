...
INSERT INTO tipo_publicacion (nombre_tipo_publicacion, descripcion_tipo_publicacion) VALUES
  ('servicio', 'Información sobre servicios disponibles en la unidad educativa, como asesorías, apoyo, etc.'),
  ('anuncio', 'Anuncios importantes y comunicados para la comunidad educativa.'),
  ('noticia', 'Noticias relevantes sobre eventos, logros o novedades en la unidad educativa.');
...
VALUES (
    1, 1, 2, '', 'Administración', 'UEESCH', 'ueesch2023@gmail.com', '$2a$08$jSKtYdaK1DmdfWUCgVYCm.G0zA/piaFrJ6ogTzOKmY8LXohAJ6S/S', 'http://drive.google.com/uc?export=view&id=1C1YbQTRAlEQ3UT-CgXPGWH3JMw8pVBuK', '2024-01-28', NULL, NULL, NULL
);
